...
@section ('styles')
    <style>
        ...
        .input-academic:focus {
            ...
            box-shadow:
                inset 1px 1.5px 3px oklch(20% 0.012 250 / 0.02),
                0 0 0 4px oklch(66% 0.18 235 / 0.15);
...
@section ('content')
                        ...
                        <div class="form-group opacity-0 translate-y-4 flex items-center justify-between mt-6">
                            <label for="remember_me" class="flex items-center cursor-pointer group select-none">
                                <input
                                    ...
                                    type="checkbox"
                                    name="remember"
                                    class="w-4 h-4 rounded border-slate-300 text-ink focus:ring-ink cursor-pointer transition-colors"
    ...
    <!-- Inisialisasi Animasi & Skrip Interaktif -->
    <script>
