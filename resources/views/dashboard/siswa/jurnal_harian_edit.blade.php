...
@section ('content')
    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto">
            <div class="mb-8">
                <a href="{{ route('siswa.jurnal-harian.index', ['tab' => 'riwayat']) }}" class="inline-flex items-center text-sm font-medium text-slate-500 hover:text-blue-600 transition-colors mb-4">
                ...
                <form action="{{ route('siswa.jurnal-harian.update', $jurnal_harian->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            class="w-full bg-white rounded-xl border border-slate-200 px-4 py-3 text-slate-700 focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-all resize-y @error('kegiatan') border-rose-500 ring-rose-100 @enderror"
                            required
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="bukti_foto"
                            accept="image/*"
                            class="w-full bg-white rounded-xl border border-slate-200 px-4 py-2.5 text-slate-700 focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-all file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 @error('bukti_foto') border-rose-500 @enderror"
                        />
                    ...
                    <div class="pt-4 border-t border-slate-100 flex items-center gap-3">
                        <button
                            type="submit"
                            class="bg-blue-700 hover:bg-blue-800 text-white font-bold py-3 px-8 rounded-xl shadow-sm transition-colors flex items-center gap-2"
                        >
