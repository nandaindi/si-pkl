    ...
    <div>
        <div class="max-w-7xl mx-auto">
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
                <div>
                    <h2 class="text-2xl font-bold text-slate-900">Kelola Guru Pembimbing</h2>
                    <p class="text-slate-500 text-sm mt-1">Manajemen alokasi guru pembimbing PKL.</p>
                </div>
                <a
                    href="{{ route('admin.guru-pembimbing.create') }}"
                                ...
                                <tr class="hover:bg-slate-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-sm text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <form
                                                action="{{ route('admin.guru-pembimbing.destroy', $guru->id) }}"
                                                method="POST"
                                                data-confirm="Yakin ingin menghapus guru pembimbing ini?"
                                                class="inline"
                                            >
                                                @csrf
                                                @method ('DELETE')
                                ...
                                <tr>
                                    <td colspan="4" class="px-6 py-12 text-center text-slate-500">
                                        <div class="flex flex-col items-center justify-center">
                                            <p class="text-sm font-medium">Belum ada data guru pembimbing yang ditugaskan.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
