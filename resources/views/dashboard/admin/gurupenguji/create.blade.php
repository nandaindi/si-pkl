...
@section ('content')
    <div class="max-w-4xl mx-auto py-8">
        <div class="mb-8">
            <h2 class="text-2xl font-bold text-slate-900">Tambah Guru Penguji</h2>
            <p class="text-slate-500 text-sm mt-1">Buat akun dan lengkapi profil guru penguji baru.</p>
        </div>
        <form
