...
@section ('content')
    <div class="max-w-4xl mx-auto py-8">
        <div class="mb-8">
            <h2 class="text-2xl font-bold text-slate-900">Edit Guru Penguji</h2>
            <p class="text-slate-500 text-sm mt-1">Perbarui akun dan profil guru penguji.</p>
        </div>
        <form
            action="{{ route('admin.guru-penguji.update', $guru->id) }}"
            method="POST"
