    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex items-center gap-4 border-b border-slate-200 mb-6">
                <a href="{{ route('pembimbing.laporan-harian.index') }}" class="px-4 py-3 text-sm font-bold text-slate-500 hover:text-blue-700 border-b-2 border-transparent hover:border-blue-700 transition-all flex items-center gap-2">
                    Laporan Harian
                </a>
                <a href="{{ route('pembimbing.laporan.index') }}" class="px-4 py-3 text-sm font-bold text-blue-700 border-b-2 border-blue-700 transition-all">Laporan Akhir</a>
            </div>
                                ...
                                <tr class="hover:bg-slate-50 transition-colors group">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            >
                                                {{ substr($akhir->siswa->user->name, 0, 1) }}
                                            </div>
                                            <div>
                                    ...
                                    <td class="px-6 py-4">
                                        <a
                                            ...
                                            target="_blank"
                                            class="inline-flex items-center gap-2 px-4 py-2 bg-slate-100 hover:bg-blue-50 text-slate-600 hover:text-blue-700 rounded-xl font-bold text-xs transition-colors"
                                        >
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <a
                                            ...
                                            class="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 hover:bg-blue-100 text-blue-600 border border-blue-200 font-bold text-xs rounded-xl transition-colors"
                                        >
